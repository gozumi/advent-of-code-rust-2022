...
pub fn process_lines(lines_buffer: Lines<BufReader<File>>) {
    ...
    for line in lines_buffer {
        ...
        if do_sections_0_and_sections_1_overlap(elf_pair_sections.0, elf_pair_sections.1)
            || (do_sections_0_and_sections_1_overlap(elf_pair_sections.1, elf_pair_sections.0))
        {
...
fn do_sections_0_and_sections_1_overlap(sections_0: (i16, i16), sections_1: (i16, i16)) -> bool {
    return (sections_0.0 <= sections_1.0 && sections_0.1 >= sections_1.0)
        || (sections_0.0 <= sections_1.1 && sections_0.1 >= sections_1.1);
}
